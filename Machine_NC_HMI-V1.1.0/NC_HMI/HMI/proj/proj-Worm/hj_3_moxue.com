...
//M(Mask0/$85020/"blank.png"/)
  ...
  ;;基础参数
	DEF VAR_GRD0=(R/*-1=$85125,1=$85124//$85103,$85103,,/WR2/"panel_5_2_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[1]"/380,30,190/460,30,70/,4);工件旋向
	DEF VAR_GRD1=(I///$85102,$85102,$85051,/WR2/"panel_5_3_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[2]"/380,50,190/460,50,70/,4);工件头数
	DEF VAR_GRD2=(R5///$85173,$85173,,/WR2/"panel_5_4_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[3]"/380,70,150/460,70,70/,4);蜗杆模数
	DEF VAR_GRD3=(R5///$85104,$85104,$85043,/WR1/"panel_5_4_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[5]"/380,90,190/460,90,70/3,4);蜗杆螺距
	DEF VAR_GRD4=(R///$85108,$85108,$85043,/WR2/"panel_5_5_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[10]"/380,110,190/460,110,70/,4);工件左端
	DEF VAR_GRD5=(R///$85109,$85109,$85043,/WR2/"panel_5_6_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[11]"/380,130,190/460,130,70/,4);工件右端
	DEF VAR_GRD6=(R///$85165,$85145,$85043,/WR2/"panel_5_7_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[14]"/380,150,150/460,150,70/,4);对刀起始位置
  ;;锥度
	DEF VAR_GRD7=(I/*0=$85014,1=$85013//$85159,$85159,,/WR2/"panel_5_8_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[14]"/380,230,80/415,230,30/);是否有锥度
	DEF VAR_GRD8=(R7/-1,1//$85160,,,/WR2/"panel_5_8_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[15]"/0,0,0/460,230,70/,4);锥度值
  ;;自动螺旋升角
	...
	DEF VAR_GRD11=(I/0,45//$85055,,,$85042/WR2/"panel_5_10_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[9]"/0,0,0/460,250,70/,4);度
	DEF VAR_GRD12=(I/0,59//$85056,,,$85053/WR2/"panel_5_11_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[10]"/0,0,0/490,250,70/,4);分
	DEF VAR_GRD13=(I/0,59//$85057,,,$85054/WR2/"panel_5_12_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[11]"/0,0,0/520,250,70/,4);秒
	DEF VAR_GRD14=(R/0,400//$85107,$85107,,$85043,/WR4//"/NC/_N_NC_GD2_ACX/GRIND[21]"/380,270,190/460,270,120/,4);分度圆直径
  ;;工件装夹位
	DEF VAR_GRD15=(R///$85112,$85112,$85043,/WR2//"/NC/_N_NC_GD2_ACX/POSITION[3]"/380,170,190/460,170,70/,4);装夹工件时X轴坐标
	DEF VAR_GRD16=(R///$85113,$85113,$85043,/WR2//"/NC/_N_NC_GD2_ACX/POSITION[4]"/380,190,190/460,190,70/,4);装夹工件时Z轴坐标
	DEF VAR_GRD17=(R///$85114,$85114,$85055,/WR2//"/NC/_N_NC_GD2_ACX/POSITION[5]"/380,210,190/460,210,70/,4);装夹工件时C轴角度
  ;;其他参数
	...
	DEF VAR11=(R/*0=$85149,1=$85150/0/$85089,$85089,,/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[23]"/0,0,0/260,30,70/,4);标准磨削时使用左齿面对刀参数
	DEF VAR12=(I/*0=$85039,1=$85038//$85913,$85913,,/WR0//"/NC/_N_NC_GD2_ACX/CONFIG[1]"/0,0,0/0,0,0/,4);有无自动对刀0=无/1=有	
  ;;按键定义
	HS1=($85001,ac7,se3)
	HS2=($85003,ac7,se1)
	HS3=($85002,ac7,se1)
	...
	PRESS(HS3)
		...
		ELSE
			LM("Mask1","hj_3_gongyi.com",0);调整工艺界面
		ENDIF
	END_PRESS
	PRESS(HS4)
	...
	END_PRESS
	PRESS(HS8)
		LM("Mask0","hj_3_peizhi.com",0);配置参数界面
	END_PRESS
	PRESS(VS8)
		EXIT
	END_PRESS
...
//M(Mask1/$85020/"blank.png"/)
  ...
  ;;基础参数
	...
	DEF VAR_GRD1=(I///$85102,$85102,$85051,/WR2/"panel_5_3_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[2]"/380,50,190/460,50,70/,4);工件头数
  ;;双导程
	DEF VAR_GRD2_0=(R///$85187,$85187,,/WR2/"panel_5_4_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[3]"/380,70,150/460,70,70/,4);左齿模数
	DEF VAR_GRD3_0=(R///$85188,$85188,$85043,/WR1/"panel_5_4_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[5]"/380,90,190/460,90,70/3,4);左齿螺距	
	DEF VAR_GRD2_1=(R///$85189,$85189,,/WR2/"panel_5_4_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[25]"/380,110,150/460,110,70/,4);右齿模数
	DEF VAR_GRD3_1=(R///$85190,$85190,$85043,/WR1/"panel_5_4_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[27]"/380,130,190/460,130,70/3,4);右齿螺距

	DEF VAR_GRD4=(R///$85108,$85108,$85043,/WR2/"panel_5_5_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[10]"/380,155,190/460,155,70/,4);工件左端
	DEF VAR_GRD5=(R///$85109,$85109,$85043,/WR2/"panel_5_6_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[11]"/380,175,190/460,175,70/,4);工件右端
	DEF VAR_GRD6=(R///$85165,$85145,$85043,/WR2/"panel_5_7_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[14]"/380,195,150/460,195,70/,4);对刀起始位置
  ;;锥度
	DEF VAR_GRD7=(I/*0=$85014,1=$85013//$85159,$85159,,/WR2/"panel_5_8_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[14]"/40,220,80/75,220,30/);是否有锥度
	DEF VAR_GRD8=(R7/-1,1//$85160,,,/WR2/"panel_5_8_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[15]"/0,0,0/120,220,70/,4);锥度值
  ;;自动螺旋升角
	DEF VAR_GRD11=(I/0,45//$85055,$85164,,$85042/WR2/"panel_5_10_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[9]"/40,240,80/120,240,70/,4);度
	DEF VAR_GRD12=(I/0,59//$85056,,,$85053/WR2/"panel_5_11_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[10]"/0,0,0/150,240,70/,4);分
	DEF VAR_GRD13=(I/0,59//$85057,,,$85054/WR2/"panel_5_12_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[11]"/0,0,0/180,240,70/,4);秒
  ;;工件装夹位
	DEF VAR_GRD15=(R///$85112,$85112,$85043,/WR2//"/NC/_N_NC_GD2_ACX/POSITION[3]"/380,220,190/460,220,70/,4);装夹工件时X轴坐标
	DEF VAR_GRD16=(R///$85113,$85113,$85043,/WR2//"/NC/_N_NC_GD2_ACX/POSITION[4]"/380,240,190/460,240,70/,4);装夹工件时Z轴坐标
	DEF VAR_GRD17=(R///$85114,$85114,$85055,/WR2//"/NC/_N_NC_GD2_ACX/POSITION[5]"/380,260,190/460,260,70/,4);装夹工件时C轴角度
  ;;其他参数
	DEF VAR0=(I/*0=$85166,1=$85167//,,,/WR2/"panel_5_0_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[12]"/380,10,190/460,10,70/7,4);加工模式
  ...
  ;;按键定义
	...
	PRESS(HS3)
		...
		ELSE
			LM("Mask3","hj_3_gongyi.com",0);调整工艺界面
		ENDIF
	END_PRESS
	PRESS(HS4)
		LM("Mask0","hj_3_duidao.com",0);修整界面
