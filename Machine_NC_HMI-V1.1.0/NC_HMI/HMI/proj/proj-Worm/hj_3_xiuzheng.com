...
//M(Mask0/$85711/"panel_2_8_chs.png"/)
	;;修整参数
		DEF XIU_ZHENG=(R/*2=$85185,3=$85186/3/$85101,$85101,,/WR1//"/NC/_N_NC_GD2_ACX/CONFIG[7]"/0,0,0/350,10,70/3,4);修整器结构选择
		DEF PROGRAM_NAME=(S///$85390,$85390,/WR2//"/NC/_N_NC_GD2_ACX/WORM_SHAPE"/355,30,150/440,30,80/,4);存储齿形程序名,蜗杆磨床时可手动输入,齿形,生成文件用
		DEF VAR_SL0=(I/*0=$85327,1=$85328//,,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[8]"/355,10,110/440,10,60/7,4);新旧砂轮
		DEF VAR_SL1=(I/2,1000//$85342,$85342,,/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[11]"/355,50,110/440,50,60/,4);总修整次数
		DEF VAR_SL2=(R/0,0.5//$85308,$85308,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[12]"/355,70,110/440,70,110/7,4);粗修量
		DEF VAR_SL3=(R/0,1000//$85306,$85306,,$85045/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[13]"/355,90,110/440,90,110/,4);粗修速度
		DEF VAR_SL4=(I/0,1000/0/$85341,$85341,,/WR4//"/NC/_N_NC_GD2_ACX/DRESSER[14]"/355,95,110/440,95,60/,4);精修次数
		...
		DEF VAR_SL9_0=(R/0,1000//$85320,$85320,,$85043/WR1//"$R[9]"/325,290,110/440,290,110/3,4);砂轮当前直径
		...
		DEF VAR_SL12=(R2///$85304,$85304,,$85044/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[3]"/295,330,130/440,330,110/,4);最大砂轮磨削直径
		DEF VAR_SL13=(R2///$85303,$85303,,$85044/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[4]"/295,350,130/440,350,110/,4);最小砂轮磨削直径					
	;;滚轮参数
