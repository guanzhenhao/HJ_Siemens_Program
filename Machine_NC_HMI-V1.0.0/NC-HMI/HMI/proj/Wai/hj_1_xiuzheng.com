...
//M(Mask0/$85711/"panel_2_2_chs.png"/)
	;;修整参数
		...
		DEF VAR_SL12=(R2///$85304,$85304,,$85043/WR2,ac3//"/NC/_N_NC_GD2_ACX/DRESSER[3]"/295,330,130/440,330,110/7,4);最大砂轮磨削直径
		DEF VAR_SL13=(R2///$85303,$85303,,$85043/WR2,ac3//"/NC/_N_NC_GD2_ACX/DRESSER[4]"/295,350,130/440,350,110/7,4);最小砂轮磨削直径
	;;滚轮参数
		...
		DEF VAR_GL6=(R///$85607,$85608,,$85043/WR2/"panel_2_1_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[7]"/40,210,110/120,210,110/7,4);砂轮中心与滚轮中心水平重合时Z(W)轴坐标
...
//M(Mask2/$85711/"panel_2_8_chs.png"/)
	;;修整参数
		DEF VAR_SL0_0=(I/*0=$85383,1=$85384,2=$85385,3=$85391//,,,/WR2,ac3//"/NC/_N_NC_GD2_ACX/DRESSER[28]"/0,0,0/355,10,60/6,4);齿形选择
	...
	;;定义按键		
		...
		PRESS(VS1)
			...
			ENDIF
			IF VAR_SL0_0.VAL==3
				LM("Mask0","hj_1_kuozhan.com",0);修整界面
			ENDIF
		END_PRESS
		PRESS(VS8)
			LM("Mask0","hj_1_moxue.com",0);磨削界面
