...
//M(Mask0/$85231/"panel_3_1_chs.png"/)
    ;;粗磨
        DEF POSITION_0=(I/*0=$85233,1=$85234//$85203,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[1]"/0,0,0/122,103,60/3,4);单双磨
        DEF POSITION_1=(I///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[2]"/0,0,0/122,126,60/,4);粗磨次数
        DEF POSITION_2=(R/0,0.2//$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[3]"/0,0,0/122,149,60/7,4);粗磨进给
        DEF POSITION_3=(R/0,50//$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[4]"/0,0,0/122,174,60/,4);粗磨头架转速
        DEF POSITION_4=(I///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[5]"/0,0,0/122,197,60/,4);粗磨修整设定
        DEF POSITION_5=(R///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[6]"/0,0,0/122,221,60/,4);粗磨磨削砂轮线速度
        DEF POSITION_10=(R2///$85203,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[11]"/0,0,0/122,245,60/3,4);粗磨磨削砂轮转速
    ;;半精磨
        DEF POSITION_20=(I/*0=$85233,1=$85234//$85204,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[21]"/0,0,0/212,103,60/3,4);单双磨
        DEF POSITION_21=(I///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[22]"/0,0,0/212,126,60/,4);半精磨次数
        DEF POSITION_22=(R/0,0.15//$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[23]"/0,0,0/212,149,60/7,4);半精磨进给
        DEF POSITION_23=(R/0,50//$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[24]"/0,0,0/212,174,60/,4);半精磨头架转速
        DEF POSITION_24=(I///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[25]"/0,0,0/212,197,60/,4);半精磨修整设定
        DEF POSITION_25=(R///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[26]"/0,0,0/212,221,60/,4);半精磨磨削砂轮线速度
        DEF POSITION_30=(R2///$85204,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[31]"/0,0,0/212,245,60/3,4);半精磨磨削砂轮转速
    ;;精磨
        DEF POSITION_40=(I/*0=$85233,1=$85234//$85205,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[41]"/0,0,0/302,103,60/3,4);单双磨
        DEF POSITION_41=(I///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[42]"/0,0,0/302,126,60/,4);精磨次数
        DEF POSITION_42=(R/0,0.1//$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[43]"/0,0,0/302,149,60/7,4);精磨进给
        DEF POSITION_43=(R/0,50//$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[44]"/0,0,0/302,174,60/,4);精磨头架转速
        DEF POSITION_44=(I///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[45]"/0,0,0/302,197,60/,4);精磨修整设定
        DEF POSITION_45=(R///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[46]"/0,0,0/302,221,60/,4);精磨磨削砂轮线速度
        DEF POSITION_50=(R2///$85205,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[51]"/0,0,0/302,245,60/3,4);精磨磨削砂轮转速
    ;;终磨
        DEF POSITION_60=(I/*0=$85233,1=$85234//$85206,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[61]"/0,0,0/392,103,60/3,4);单双磨
        DEF POSITION_61=(I///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[62]"/0,0,0/392,126,60/,4);终磨次数
        DEF POSITION_62=(R/0,0.05//$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[63]"/0,0,0/392,149,60/7,4);终磨进给
        DEF POSITION_63=(R/0,50//$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[64]"/0,0,0/392,174,60/,4);终磨头架转速
        DEF POSITION_64=(I///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[65]"/0,0,0/392,197,60/,4);终磨修整设定
        DEF POSITION_65=(R///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[66]"/0,0,0/392,221,60/,4);终磨磨削砂轮线速度
        DEF POSITION_70=(R2///$85206,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[71]"/0,0,0/392,245,60/3,4);终磨磨削砂轮转速
...
//M(Mask1/$85232/"panel_3_1_chs.png"/)
    ;;粗磨
        DEF POSITION_0=(I/*0=$85233,1=$85234//$85203,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[121]"/0,0,0/122,103,60/3,4);单双磨
        DEF POSITION_1=(I///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[122]"/0,0,0/122,126,60/,4);粗磨次数
        DEF POSITION_2=(R/0,0.2//$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[123]"/0,0,0/122,149,60/7,4);粗磨进给
        DEF POSITION_3=(R/0,50//$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[124]"/0,0,0/122,174,60/,4);粗磨头架转速
        DEF POSITION_4=(I///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[125]"/0,0,0/122,197,60/,4);粗磨修整设定
        DEF POSITION_5=(R///$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[126]"/0,0,0/122,221,60/,4);粗磨磨削砂轮线速度
        DEF POSITION_10=(R2///$85203,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[131]"/0,0,0/122,245,60/3,4);粗磨磨削砂轮转速
    ;;半精磨
        DEF POSITION_20=(I/*0=$85233,1=$85234//$85204,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[141]"/0,0,0/212,103,60/3,4);单双磨
        DEF POSITION_21=(I///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[142]"/0,0,0/212,126,60/,4);半精磨次数
        DEF POSITION_22=(R/0,0.15//$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[143]"/0,0,0/212,149,60/7,4);半精磨进给
        DEF POSITION_23=(R/0,50//$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[144]"/0,0,0/212,174,60/,4);半精磨头架转速
        DEF POSITION_24=(I///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[145]"/0,0,0/212,197,60/,4);半精磨修整设定
        DEF POSITION_25=(R///$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[146]"/0,0,0/212,221,60/,4);半精磨磨削砂轮线速度
        DEF POSITION_30=(R2///$85204,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[151]"/0,0,0/212,245,60/3,4);半精磨磨削砂轮转速
    ;;精磨
        DEF POSITION_40=(I/*0=$85233,1=$85234//$85205,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[161]"/0,0,0/302,103,60/3,4);单双磨
        DEF POSITION_41=(I///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[162]"/0,0,0/302,126,60/,4);精磨次数
        DEF POSITION_42=(R/0,0.1//$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[163]"/0,0,0/302,149,60/7,4);精磨进给
        DEF POSITION_43=(R/0,50//$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[164]"/0,0,0/302,174,60/,4);精磨头架转速
        DEF POSITION_44=(I///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[165]"/0,0,0/302,197,60/,4);精磨修整设定
        DEF POSITION_45=(R///$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[166]"/0,0,0/302,221,60/,4);精磨磨削砂轮线速度
        DEF POSITION_50=(R2///$85205,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[171]"/0,0,0/302,245,60/3,4);精磨磨削砂轮转速
    ;;终磨
        DEF POSITION_60=(I/*0=$85233,1=$85234//$85206,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[181]"/0,0,0/392,103,60/3,4);单双磨
        DEF POSITION_61=(I///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[182]"/0,0,0/392,126,60/,4);终磨次数
        DEF POSITION_62=(R/0,0.05//$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[183]"/0,0,0/392,149,60/7,4);终磨进给
        DEF POSITION_63=(R/0,50//$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[184]"/0,0,0/392,174,60/,4);终磨头架转速
        DEF POSITION_64=(I///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[185]"/0,0,0/392,197,60/,4);终磨修整设定
        DEF POSITION_65=(R///$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/PROCESSER[186]"/0,0,0/392,221,60/,4);终磨磨削砂轮线速度
        DEF POSITION_70=(R2///$85206,,,/WR1//"/NC/_N_NC_GD2_ACX/PROCESSER[191]"/0,0,0/392,245,60/3,4);终磨磨削砂轮转速
...
//M(Mask2/$85231/"panel_3_2_chs.png"/)
    ...
    ;;提示参数
        DEF VAR5=(R////WR4//"/NC/_N_NC_GD2_ACX/DRESSER[2]"/0,0,0/0,0,0);当前砂轮直径    
        DEF BIAOJI=(R/*0=$85191,1=$85192//$85089,$85089,,/WR4//"/NC/_N_NC_GD2_ACX/GRIND[28]"/0,0,0/380,10,70/3,4);0=X向磨削/1=双齿面磨削
	    DEF CHOOSE_1=(R/*0=$85041,1=$85040//$85246,$85246,,/WR2//"/NC/_N_NC_GD2_ACX/GRIND[29]"/100,5,150/210,5,100/,4);是否X向磨削
        DEF CHOOSE_2=(R/*0=$85041,1=$85040//$85247,$85247,,/WR2//"/NC/_N_NC_GD2_ACX/GRIND[30]"/100,25,150/210,25,100/,4);是否Z向磨削
        DEF CHOOSE_3=(R/*0=$85248,1=$85249,2=$85250//$85251,$85251,,/WR4//"/NC/_N_NC_GD2_ACX/GRIND[31]"/0,0,00/330,25,100/,4);Z向磨削选择
    ;;定义按键
        VS1=($85166,ac7,se3)
        VS2=($85167,ac7,se1)
        VS8=($85005,ac7,se1)
