...
//M(Mask0/$85026/"panel_4_1_chs.png"/)
	...
	DEF VAR5=(I/*0="左端面测量",1="右端面测量"//"基准面位置","基准面位置",,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[32]"/0,0,0/100,30,150/);基准面位置
	DEF BIAOJI=(R/*0=$85191,1=$85192//$85089,$85089,,/WR4//"/NC/_N_NC_GD2_ACX/GRIND[28]"/0,0,0/380,10,70/3,4);0=X向磨削/1=双齿面磨削
	DEF DD_MX=(R/*0=$85041,1=$85040//$85915,$85914,,/WR2//"/NC/_N_NC_GD2_ACX/CONFIG[6]"/310,100,150/440,100,60/,);自动对刀完是否磨削0=否,1=是
;;按键定义
	VS8=($85005,ac7,se1)
    PRESS(VS8)
        IF BIAOJI.VAL==0
