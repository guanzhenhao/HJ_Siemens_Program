...
;;基础参数
	DEF VAR_GRD0=(R/*-1=$85125,1=$85124//$85103,$85103,,/WR2/"panel_1_2_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[1]"/380,30,190/460,30,70/,4);工件旋向
	DEF VAR_GRD1=(I///$85102,$85102,$85051,/WR2/"panel_1_3_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[2]"/380,50,190/460,50,70/,4);工件头数
	DEF VAR_GRD2=(R///$85110,$85110,$85043,/WR4//"/NC/_N_NC_GD2_ACX/GRIND[4]"/380,70,190/460,70,70/,4);工件导程
	DEF VAR_GRD3=(R///$85104,$85104,$85043,/WR2/"panel_1_4_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[5]"/380,70,190/460,70,70/,4);工件螺距
	DEF VAR_GRD4=(R///$85108,$85108,$85043,/WR2/"panel_1_5_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[10]"/380,90,190/460,90,70/,4);工件左端
	DEF VAR_GRD5=(R///$85109,$85109,$85043,/WR2/"panel_1_6_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[11]"/380,110,190/460,110,70/,4);工件右端
...
;;锥度
	...
	DEF VAR_GRD8=(R7/-1,1//$85160,,,/WR2/"panel_1_8_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[15]"/0,230,0/460,230,70/,4);锥度值
;;自动螺旋升角
	...
	DEF VAR_GRD11=(I/0,45//$85055,,,$85042/WR2/"panel_1_10_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[9]"/0,250,0/460,250,75/,4);度
	DEF VAR_GRD12=(I/0,59//$85056,,,$85053/WR2/"panel_1_11_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[10]"/0,250,0/495,250,70/,4);分
	DEF VAR_GRD13=(I/0,59//$85057,,,$85054/WR2/"panel_1_12_chs.png"/"/NC/_N_NC_GD2_ACX/GRIND[11]"/0,250,0/525,250,70/,4);秒
	DEF VAR_GRD14=(R/0,400//$85107,$85107,,$85043,/WR4//"/NC/_N_NC_GD2_ACX/GRIND[21]"/355,270,190/460,270,120/,4);分度圆直径
;;工件装夹位
	DEF VAR_GRD15=(R///$85112,$85112,$85043,/WR2/"panel_1_13_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[3]"/380,160,190/460,160,70/,4);装夹工件时X轴坐标
	DEF VAR_GRD16=(R///$85113,$85113,$85043,/WR2/"panel_1_14_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[4]"/380,180,190/460,180,70/,4);装夹工件时Z轴坐标
	DEF VAR_GRD17=(R///$85114,$85114,$85055,/WR2/"panel_1_15_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[5]"/380,200,190/460,200,70/,4);装夹工件时C轴角度
;;其他参数
	...
	DEF VAR8=(R/*0=$85180,1=$85184,2=$85182//$85101,$85101,,/WR1//"/NC/_N_NC_GD2_ACX/CONFIG[7]"/0,0,0/380,10,70/3,4);修整器结构选择
	DEF VAR9=(R/*0=$85087,1=$85088//$85089,$85089,,/WR2/"panel_1_0_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[6]"/0,0,0/290,10,70/7,4);是否首件对刀
	DEF VAR10=(I/*0=$85039,1=$85038//$85913,$85913,,/WR0//"/NC/_N_NC_GD2_ACX/CONFIG[1]"/0,0,0/0,0,0/7,4);有无自动对刀0=无/1=有
;;按键定义
	HS1=($85001,ac7,se3)
	HS2=($85003,ac7,se1)
	HS3=($85002,ac7,se1)
	...
	PRESS(HS2)
		IF VAR8.VAL==0
			LM("Mask0","hj_0_xiuzheng.com",0);成型轮X修整
		ENDIF
		IF VAR8.VAL==1
			LM("Mask1","hj_0_xiuzheng.com",0);成型轮Z修整
		ENDIF
		IF VAR8.VAL==2
			LM("Mask2","hj_0_xiuzheng.com",0);X-Z插补修整
		ENDIF
	END_PRESS
	PRESS(HS3)
		IF	VAR0.VAL==0
			LM("Mask0","hj_0_gongyi.com",0);批量工艺界面
		ELSE
			LM("Mask1","hj_0_gongyi.com",0);调整工艺界面
		ENDIF
	END_PRESS
	PRESS(HS4)
		LM("Mask0","hj_0_duidao.com",0);自动对刀界面
	END_PRESS
	PRESS(HS8)
		LM("Mask0","hj_0_peizhi.com",0);配置参数界面
	END_PRESS
	PRESS(VS8)
		EXIT
	END_PRESS
