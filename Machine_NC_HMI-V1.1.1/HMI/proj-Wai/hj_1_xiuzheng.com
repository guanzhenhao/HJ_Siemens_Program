...
//M(Mask0/$85711/"panel_2_2_chs.png"/)
	;;修整参数
		...
		DEF VAR_SL7=(R/0,1//$85324,$85323,,$85043/WR2//"/NC/_N_NC_GD2_ACX/CONFIG[19]"/355,190,110/440,190,110/6,4);砂轮修整退刀距离
		...
		DEF VAR_SL10=(R/0,80//$85317,$85317,,$85046/WR2,ac3//"/NC/_N_NC_GD2_ACX/DRESSER[18]"/340,250,110/440,250,110/,4);砂轮线速度
		DEF VAR_SL11=(R2///$85221,$85221,,$85044/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[26]"/355,230,110/440,230,110/3,4);修整时砂轮转速
		DEF VAR_SL12=(R2///$85304,$85304,,$85043/WR2,ac3//"/NC/_N_NC_GD2_ACX/DRESSER[3]"/295,330,130/440,330,110/,4);最大砂轮磨削直径
		DEF VAR_SL13=(R2///$85303,$85303,,$85043/WR2,ac3//"/NC/_N_NC_GD2_ACX/DRESSER[4]"/295,350,130/440,350,110/,4);最小砂轮磨削直径
	;;滚轮参数
		...
		DEF VAR_GL6=(R///$85607,$85608,,$85043/WR2/"panel_2_1_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[7]"/40,210,110/120,210,110/,4);砂轮中心与滚轮中心水平重合时Z(W)轴坐标
		DEF VAR_GL6_0=(R/*0=$85041,1=$85040//$85181,$85181,,/WR0//"/NC/_N_NC_GD2_ACX/CONFIG[9]"/0,0,0/0,0,0/6,4);是否同时开放成型V和V-W插补0=否、1=是
	;;定义按键
	VS8=($85005,ac7,se1)
	PRESS(VS8)
...
//M(Mask1/$85711/"panel_2_2_chs.png"/)
	...
	;;滚轮参数
		...
		DEF VAR_GL4=(R/0,60//$85621,$85621,,$85046/WR2/"panel_2_6_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[10]"/10,350,110/120,350,110/,4);修整轮线速度
		DEF VAR_GL5=(R2///$85600,$85600,,$85044/WR1//"$R[297]"/25,330,110/120,330,110/3,4);修整轮转速
		DEF VAR_GL6=(R///$85607,$85608,,$85043/WR2,ac3/"panel_2_1_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[7]"/40,210,110/120,210,110/6,4);砂轮中心与滚轮中心水平重合时Z(W)轴坐标	
	;;定义按键
	VS8=($85005,ac7,se1)
	PRESS(VS8)
		LM("Mask0","hj_1_moxue.com",0);磨削界面
...
//M(Mask2/$85711/"panel_2_8_chs.png"/)
	;;修整参数
		...
		DEF VAR_SL13=(R2///$85303,$85303,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[4]"/295,350,130/440,350,110/,4);最小砂轮磨削直径		
	;;滚轮参数
		DEF VAR_JZ0=(R///$85609,$85608,,$85043/WR2,ac3/"panel_2_7_chs.png"/"/NC/_N_NC_GD2_ACX/POSITION[7]"/10,200,110/110,200,110/6,4);砂轮中心与滚轮中心水平重合时Z(W)轴坐标	
		...
		DEF VAR_SL0_0=(I/*0=$85383,1=$85384,2=$85385,3=$85391//,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[28]"/0,0,0/0,0,0/,4);齿形选择
		DEF VAR0=(R/*0=$85041,1=$85040//$85383,$85383,,/WR2//"/NC/_N_NC_GD2_ACX/CONFIG[10]"/0,0,0/0,0,0/,4);三角齿开放0=否,1=是
		DEF VAR1=(R/*0=$85041,1=$85040//$85384,$85384,,/WR2//"/NC/_N_NC_GD2_ACX/CONFIG[11]"/0,0,0/0,0,0/,4);梯形齿开放0=否,1=是
		DEF VAR2=(R/*0=$85041,1=$85040//$85385,$85385,,/WR2//"/NC/_N_NC_GD2_ACX/CONFIG[12]"/0,0,0/0,0,0/,4);双圆弧开放0=否,1=是
		DEF VAR3=(R/*0=$85041,1=$85040//$85391,$85391,,/WR2//"/NC/_N_NC_GD2_ACX/CONFIG[13]"/0,0,0/0,0,0/,4);扩展齿形开放0=否,1=是
		DEF PROGRAM_NAME=(S///$85390,$85390,/WR4//"/NC/_N_NC_GD2_ACX/WORM_SHAPE"/280,10,100/355,10,70/,4);扩展齿形文件名称
	;;定义按键		
		VS1=($85383,ac7,se2)
		VS2=($85384,ac7,se2)
		VS3=($85385,ac7,se2)
